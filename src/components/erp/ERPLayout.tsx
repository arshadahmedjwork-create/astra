...
const Marquee = () => {
    return (
        <div className="bg-amber-100 border-b border-amber-200 overflow-hidden py-1.5 px-4 h-8 flex items-center shrink-0">
            <motion.div
                animate={{ x: ['100%', '-100%'] }}
                transition={{
                    duration: 25,
                ...
                className="whitespace-nowrap text-amber-900 text-xs font-bold"
            >
                Next day Delivery cutoff time is 7PM • Please place your orders before 7PM for tomorrow's delivery • Next day Delivery cutoff time is 7PM • Please place your orders before 7PM for tomorrow's delivery
            </motion.div>
        </div>
    );
};
...
const sidebarItems = [
    ...
    { name: 'My Wallet', href: '/erp/wallet', icon: CreditCard },
